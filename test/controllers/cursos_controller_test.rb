...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { descripcion: @curso.descripcion, precio: @curso.precio, titulo: @curso.titulo }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { descripcion: @curso.descripcion, precio: @curso.precio, titulo: @curso.titulo }
    assert_redirected_to curso_path(assigns(:curso))
  end
